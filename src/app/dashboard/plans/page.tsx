  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className={`grid gap-4 ${isAdmin ? "lg:grid-cols-3" : "grid-cols-1"}`}>
        {isAdmin && (
          <Card className="rounded-2xl border-0 bg-white/80 shadow-[0_10px_30px_rgba(15,23,42,0.06)] backdrop-blur-sm lg:col-span-1">
            ...
            <CardContent>
              <form action={create} className="space-y-3">
                ...
                <div className="space-y-2"><Label>Category *</Label><select name="category" defaultValue="membership" className="flex h-11 w-full rounded-xl border border-slate-200 bg-slate-50 px-3 text-sm text-slate-700"><option value="membership">Membership</option><option value="personal_training">Personal Training</option></select></div>
                ...
                <div className="space-y-2"><Label>Active</Label><select name="is_active" defaultValue="true" className="flex h-11 w-full rounded-xl border border-slate-200 bg-slate-50 px-3 text-sm text-slate-700"><option value="true">Yes</option><option value="false">No</option></select></div>
        ...
        <Card className={isAdmin ? "lg:col-span-2 overflow-hidden rounded-2xl border-0 bg-white/80 shadow-[0_10px_30px_rgba(15,23,42,0.06)] backdrop-blur-sm" : "overflow-hidden rounded-2xl border-0 bg-white/80 shadow-[0_10px_30px_rgba(15,23,42,0.06)] backdrop-blur-sm"}>
